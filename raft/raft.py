...
# this is evan's addition, because I don't think past is supported anymore
#def old_div(a, b):
#    if isinstance(b, int):
#        return (int)(a/b)
#    else:
...
class RaftNode(threading.Thread):
    def __init__(self, config, name, role='follower', verbose=True):
        ...
        # Timing variables
        self.election_timeout = random.uniform(0.4, 0.4+0.05*len(self.all_ids)) # Failed vote backoff, used for pretty much all timing related things.
