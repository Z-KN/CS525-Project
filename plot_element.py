...
elements = [3, 5, 7, 9, 11, 13, 15, 17, 19]
...
# plt.title('Time to ACK convergence/Number of ACKs for different numbers of elements')

x_axis = np.arange(len(elements))
plt.xticks(x_axis + .2, elements)
color = 'tab:red'
ax1.set_xlabel('Number of elements')
ax1.set_ylabel('Time to convergence (s)', color=color)
# ax1.plot(elements, convergence_averages, color=color)
