...
ssh kainingz@sp24-cs525-0201.cs.illinois.edu -t "cd CS525-Project && python3 network_test.py -n 1 &" 
ssh kainingz@sp24-cs525-0202.cs.illinois.edu -t "cd CS525-Project && python3 network_test.py -n 2 &" 
ssh kainingz@sp24-cs525-0203.cs.illinois.edu -t "cd CS525-Project && python3 network_test.py -n 3 &" 
ssh kainingz@sp24-cs525-0204.cs.illinois.edu -t "cd CS525-Project && python3 network_test.py -n 4 &"
